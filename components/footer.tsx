...
export function Footer() {
  return (
    <footer className="mt-auto">
      ...
      {/* Main Footer */}
      <div className="w-full bg-[#b74d80e0] py-6 px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-md">
                ...
                <li>
                  <Link href="/sell" className="text-white hover:text-gray-400">
                    Sell with Us
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="space-y-4 text-md">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white">Call : 90501 11218</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Mail className="h-5 w-5 text-white" />
                  <span className="text-white">Email : cs@ecommerce.com</span>
                </div>
              </div>
            </div>
          </div>
