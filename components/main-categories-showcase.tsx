...
function CategoryProducts({ categoryId, categoryName, description }: CategoryProductsProps) {
  ...
  return (
    <div className="space-y-6 px-10  ">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-5xl ml-3 text-[#B74D80]  font-light tracking-tight leading-tight">{categoryName}</h2>
          <p className=" ml-4 text-gray-800 text-md">{description}</p>
        </div>
